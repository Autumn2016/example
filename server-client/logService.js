...
function enter() {
    if (TRACE >= defaultLevel) {
        ...
        console.log("[" + COLOR_GREEN + "ENTER" + COLOR_WHITE + "][" + timestamp() + "][" + caller.getFileName().replace(__base, '') + "#" + caller.getLineNumber() + "@<" + caller.getFunctionName() + ">] " + COLOR_GREEN + "Enter <" + caller.getFunctionName() + ">(" + JSON.stringify(arguments) + ") ..." + COLOR_WHITE);
    }
}
